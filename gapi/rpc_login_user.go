...
func (server *Server) LoginUser(ctx context.Context, req *pb.LoginUserRequest) (*pb.LoginUserResponse, error) {
	...
	if err != nil {
		return nil, status.Errorf(codes.Internal, "Failed to create refreshToken")
	}
	...
	return rsp, status.Errorf(codes.Unimplemented, "method LoginUser not implemented")
}
